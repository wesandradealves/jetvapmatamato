        ...
        <div class="d-flex flex-column flex-md-row  ">
            <div class="flex-fill me-md-5">
                ...
                <a class="btn d-inline-block btn-cta --variation mt-4" href="https://api.whatsapp.com/send?phone=554130798009&text=Ol%C3%A1,%20" title="Fale com nossos consultores"
                    class="btn btn-cta">EU QUERO CAPINA A VAPOR NA MINHA CIDADE</a>
            </div>
...
<section id="tecnologia-por-uma-cidade-mais-sustentavel" class="tecnologia-por-uma-cidade-mais-sustentavel">
    <div class="container">
        <div class="d-block mb-5 pb-4 col-12 col-md-7">
            ...
            <p class="text ">Veja como a <strong>Jet Vap Mata Mato Urban 300</strong> é a mais eficiente e econômica solução para a <strong>capina
                urbana do seu município</strong>:</p>
        </div>
                    ...
                    <li class="table-content--content-row d-block">
                        <ul class="d-flex flex-wrap align-items-stretch justify-content-between">
                            ...
                            <li data-mobile-title="Eliminação de
                                        plantas indesejadas"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
                                <span>Demorada e plantas nascem novamente</span></li>
                            <li data-mobile-title="Eliminação de
                                        plantas indesejadas"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
                                <span>Mais rápida e definitiva</span></li>
                        </ul>
                    </li>
                    <li class="table-content--content-row d-block">
                        <ul class="d-flex flex-wrap align-items-stretch justify-content-between">
                            ...
                            <li data-mobile-title="Meio Ambiente"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
                                <span>Ecológica</span></li>
                            <li data-mobile-title="Meio Ambiente"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
                                <span>Igualmente ecológica 
pois só usa vapor</span></li>
                        </ul>
                    </li>
                    <li class="table-content--content-row d-block">
                        <ul class="d-flex flex-wrap align-items-stretch justify-content-between">
                    ...
                    <li class="table-content--content-row d-block">
                        <ul class="d-flex flex-wrap align-items-stretch justify-content-between">
                            ...
                            <li data-mobile-title="Condições de Trabalho"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
                                <span>Insegura e cansativa para os operadores</span></li>
                            <li data-mobile-title="Condições de Trabalho"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
                    ...
                    <li class="table-content--content-row d-block">
                        <ul class="d-flex flex-wrap align-items-stretch justify-content-between">
                            ...
                            <li data-mobile-title="Percepção Pública"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
                                <span>Serviço ultrapassado que atrapalha o dia a dia</span></li>
                            <li data-mobile-title="Percepção Pública"
                                class="table-content--content-row--item d-flex flex-wrap flex-column justify-content-center align-items-center ps-3 pe-3 ps-md-4 pe-md-4 ps-lg-5 pe-lg-5 pb-3 pt-3 col-6 col-md-4">
...
<section id="a-maquina-que-combina-produtividade-com-sustentabilidade"
    ...
    <div class="container">
        ...
        <p class="text">A <strong>Mata Mato Urban 300</strong> faz bem para a natureza e para os negócios.<br />Um investimento com garantia de retorno rápido.
</p>
